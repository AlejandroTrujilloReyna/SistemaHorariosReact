  ...
  return (
    ...
    <Toast ref={toast} />
      ...
      <Panel header="Consultar Docentes" className='mt-3' toggleable>
        ...
        <DataTable value={filtroDocente.length ? filtroDocente :docentesList} paginator rows={5} rowsPerPageOptions={[5, 10, 25, 50]} editMode='cell' size='small' tableStyle={{ minWidth: '50rem' }}>
