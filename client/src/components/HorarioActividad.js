  ...
  return (
    ...
    <Toast ref={toast} />
      ...
      <div className="mx-8 mb-4">
        ...
        <DataTable value={filtrohorarioactividad.length ? filtrohorarioactividad :horarioactividadList} editMode='cell' size='small' tableStyle={{ minWidth: '50rem' }}>
          {columns.map(({ field, header }) => {
              ...
              editor={field === 'clave_HorarioActividad' ? null : (options) => cellEditor(options)} onCellEditComplete={onCellEditComplete}/>;
          })}
        </DataTable>
      </Panel>        
    </>
